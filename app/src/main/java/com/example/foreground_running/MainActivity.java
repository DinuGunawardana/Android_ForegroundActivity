...
public class MainActivity extends AppCompatActivity {
    ...
    // Check and request location and background location permissions
    ...
    public void startForegroundServiceIfAllowed(View view) {
        startForegroundServiceIfAllowed();  // Already defined method
    }
